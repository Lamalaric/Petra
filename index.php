				...
				<?php
					...
					if(isset($_GET["choix"])){
						...
						if($_GET["choix"] == 1){
							...
							echo "<p>Khazneh</p>";
							echo "<p>Théâtre nabatéen</p>";
							echo "<p>Al-Khubthav</p>";
							echo "<p>Nymphaeum</p>";
							...
							echo "<p>Sîq</p>";
							echo "<p>Tombe à l'Urne</p>";
							echo "<p>Tombe de la Soie</p>";
							echo "<p>Tombe corinthienne</p>";
							echo "<p>Tombe Palace</p>";
							...
							echo "<p>Qasr al-Bint</p>";
							echo "<p>Tombe Renaissance</p>";
							echo "<p>Fontaine au lion</p>";
